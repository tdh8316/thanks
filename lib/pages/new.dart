...
class NewJournalPage extends StatefulWidget {
  ...
  @override
  _NewJournalPageState createState() => _NewJournalPageState();
}
...
class _NewJournalPageState extends State<NewJournalPage> {
  ...
  Future<Null> _checker(BuildContext context) async {
    if (fileList.contains("${(await getApplicationDocumentsDirectory()).path}"
        "/${DateFormat(fileNameFormat).format(widget.diaryDate)}.txt")) {
      await showDialog(
        context: context,
